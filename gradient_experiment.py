...
from gradient_trainloop import training_loop
...
if __name__ == '__main__':
    ...
    num_classes_iter = [2, 5]
    learning_rate_iter = [1e-3, 1e-4]
    num_samples_iter = [32, 256]
    ...
    for num_samples in num_samples_iter:
        for num_classes in num_classes_iter:
            for lr in learning_rate_iter:
                ...
                save_path = "results_gradients_" + str(num_samples) + "_" + str(num_classes) + "_" + str(lr)
